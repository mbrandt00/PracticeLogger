...
class EditablePieceModel: ObservableObject {
    ...
    init(from pieceCompatible: PieceCompatible) {
        self.id = pieceCompatible.id
        self.workName = pieceCompatible.workName
        self.nickname = pieceCompatible.nickname
        // Initialize all other fields
        
        // Convert movements
        self.movements = pieceCompatible.getMovements()
    }

...
COMMENT ON CONSTRAINT fk_collection
  ON public.pieces 
...
INSERT INTO public.movements (piece_id, name, number, key_signature, nickname, download_url)
SELECT p.id, m.name, m.number, m.key_signature, m.nickname, m.download_url
